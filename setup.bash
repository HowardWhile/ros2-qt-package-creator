...
create-new-ros-qt-console-package() {
    if [ $# -ne 2 ]; then
        echo "Please provide the correct parameters: PKG_NAME and NODE_NAME."
        echo "Usage example-1: create-new-ros-qt-console-package <PKG_NAME> <NODE_NAME>"
        echo "Usage example-2: create-new-ros-qt-console-package my_ros2qt demo"
        return 1
    fi
    ...
    cp -R $CREATE_NEW_ROS_QT_PKG_CMD_DIR/template/console ./$PKG_NAME
